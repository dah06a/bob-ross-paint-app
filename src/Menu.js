    ...
    return (
        <div className="menu bg-light">
            ...
            <nav className="navbar navbar-light bg-light">
                <div className="container-fluid justify-content-between mt-1">
                    <button className="btn btn-outline-dark paint-font" data-bs-toggle="collapse" data-bs-target="#collapsedMenu">
                        MENU{' '}
                        {menuIcon}
                    </button>
                    <h4 className="d-none d-md-block paint-font mt-1">There are no mistakes, just happy accidents.</h4>
                    <button className="btn btn-outline-dark paint-font" data-bs-toggle="offcanvas" data-bs-target="#toolsPanel">
                        TOOLS{' '}
                        {toolIcon}
                    </button>
                </div>
