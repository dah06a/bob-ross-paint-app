...
function Menu({ changeBackground }) {
                ...
                <div className="container-fluid mt-1">
                    <div className="row w-100">
                        ...
                        <div className="col col-md-2">
                            <button className="btn btn-outline-dark paint-font w-100" data-bs-toggle="offcanvas" data-bs-target="#toolsPanel">
                                TOOLS{' '}
                                {toolIcon}
                            </button>
                        </div>
                        <div className="col col-md-2">
                            <button className="btn btn-outline-dark paint-font w-100" data-bs-toggle="collapse" data-bs-target="#collapsedMenu">
                                MENU{' '}
                                {menuIcon}
                            </button>
                        </div>
